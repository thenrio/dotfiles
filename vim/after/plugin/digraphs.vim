" This file complements alpha sub and super scripts when available.
" This is useful for mathematics notations.
" syntax is <letter>s for sub, <letter>S for super.
" 
" not all letter looks available as sub or super scripts
"
" see
